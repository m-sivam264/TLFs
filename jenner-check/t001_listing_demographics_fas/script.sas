...
proc sort data = adam_adsl_sm_mock out = adsl;
	by usubjid;
	where FASFL = 'Y';
run;
...
ods rtf close;
ods escapechar='^';
ods rtf file='./16.2.4.1 Demographic Baseline Data - Full Analysis Set.rtf' style=journal;
options orientation=landscape;

proc report data=adsl_vs nowd headline headskip split="*" spacing=2
