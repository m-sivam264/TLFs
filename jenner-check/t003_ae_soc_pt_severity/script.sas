...
proc sort data = for_n; by trt01a; run;
...
ods rtf close;
ods rtf file ="./Table_14.3.2.4_TRTEMFL_AE_BySOC_PT_Severity.rtf"
  style=journal;
...
line @1"Source: Table 14.3.2.4, Dataset: ADAE, Program: Table 14.3.2.4 [Treatment-Emergent] Adverse Events By System Organ Class, Preferred Term and Maximum Severity - Option 1.sas, Output: Table_14.3.2.4_TRTEMFL_AE_BySOC_PT_Severity.rtf";
endcomp;
run;
